      ...
      <ScrollFadeView
        ...
        <View
          ...
          <Text
            ...
            If you are experiencing a mental health crisis, please contact emergency services (911)
        ...
        <View style={{ marginBottom: spacing.xl }}>
          ...
          <Text
            ...
            You may delete your account at any time from Settings. We will delete all your data
        ...
        <View style={{ marginBottom: spacing.xl }}>
          ...
          <Text
            ...
            You grant us a limited license to use your data solely to provide the App&apos;s
            features (like generating AI insights). We never use your data for advertising, never
            sell it, and never share it with third parties.
          </Text>
        </View>
        ...
        <View style={{ marginBottom: spacing.xl }}>
          ...
          <Text
            ...
            breach these Terms. Upon termination, your right to use the App will immediately cease.
          </Text>
          <Text
            style={{
              fontSize: typography.size.base,
        ...
        <View style={{ marginBottom: spacing.xl }}>
          ...
          <Text
            ...
            Any disputes arising from these Terms or the App will be resolved through binding
        ...
        <View style={{ marginBottom: spacing.xl }}>
          ...
          <Text
            ...
            will notify you via email or in-app notification at least 30 days before the changes
            take effect.
          </Text>
          <Text
            style={{
