...
```tsx
<FeaturesList title="Premium Features:" features={PREMIUM_FEATURES} />
```
...
```tsx
<PaywallSecondaryButton onPress={handleContinueFree} text="Continue with Free plan" />
```
...
```tsx
<PricingPreview text="$9.99/month • $59.99/year • $149.99 lifetime" variant="urgency" />
```
