-- Fix the create_user_profile function to use correct type for triggers
-- triggers should be text[] not jsonb
...
BEGIN
  ...
  INSERT INTO user_profiles (
    ...
    '{}'::text[], -- Fixed: Use empty text array instead of jsonb
    NOW(),
    NOW()
  )
