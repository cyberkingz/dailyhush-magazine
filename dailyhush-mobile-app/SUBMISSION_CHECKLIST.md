# Checklist de Soumission - App Store Connect
...
## 📋 TODO LIST - Soumission App Store
...
- [x] 7-day free trial créée
- [x] Screenshot uploadé
...
- [ ] 7-day free trial - **À CRÉER** (une fois pricing finalisé)
- [x] Screenshot uploadé
- [ ] Vérifier statut final (ne doit plus être "Missing Metadata")
...
1. **Première soumission:** Les subscriptions doivent être soumises avec une nouvelle version de l'app (pas individuellement)
2. **Pricing Annual:** En cours de traitement, attendre quelques minutes avant de créer le 7-day free trial
3. **Screenshots:** Tous les 3 screenshots sont uploadés ✅
4. **Statut "Missing Metadata":** Tous les 3 produits affichent encore "Missing Metadata" - cela peut être dû à:
   - Le pricing Annual qui est encore en cours de traitement
   - Le 7-day free trial Annual qui n'est pas encore créé
   - Possiblement un délai de traitement d'Apple après les modifications
5. **Subscription Group ID:** 21829692
