      ...
      >
        ...
        <View style={{ marginBottom: spacing.xl }}>
          ...
          <Text style={{ fontSize: typography.size.base, color: colors.text.secondary, lineHeight: typography.size.base * typography.lineHeight.relaxed }}>
            DailyHush is built with your privacy at its core. We believe your healing journey should be completely private. This policy explains how we collect, use, and protect your information.
          </Text>
        </View>
        ...
        <View style={{ marginBottom: spacing.xl }}>
          ...
          <Text style={{ fontSize: typography.size.base, color: colors.text.secondary, lineHeight: typography.size.base * typography.lineHeight.relaxed, marginBottom: spacing.md }}>
            Your data is encrypted both in transit and at rest. We use industry-standard security measures including:
          </Text>
          <Text style={{ fontSize: typography.size.base, color: colors.text.secondary, lineHeight: typography.size.base * typography.lineHeight.relaxed }}>
        ...
        <View style={{ marginBottom: spacing.xl }}>
          ...
          <Text style={{ fontSize: typography.size.base, color: colors.text.secondary, lineHeight: typography.size.base * typography.lineHeight.relaxed }}>
            Our AI analyzes your spiral logs to generate personalized insights. This analysis happens privately and securely. The AI never shares your personal information with anyone, including us. Pattern insights are stored only in your private account.
          </Text>
        </View>
