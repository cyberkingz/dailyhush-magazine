    ...
    <div className="bg-gradient-to-br from-emerald-50/80 via-emerald-50/50 to-amber-50/30 min-h-screen relative overflow-hidden">
      ...
      <div className="container-prose py-16 relative z-10">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-emerald-900 mb-8">Terms of Service</h1>
          ...
          <h2 className="text-2xl font-semibold text-emerald-900 mt-8 mb-4">1. Acceptance of Terms</h2>
          ...
          <h2 className="text-2xl font-semibold text-emerald-900 mt-8 mb-4">2. Description of Service</h2>
          <p className="text-emerald-700 mb-4">DailyHush provides:</p>
          ...
          <h2 className="text-2xl font-semibold text-emerald-900 mt-8 mb-4">3. User Conduct</h2>
          <p className="text-emerald-700 mb-4">You agree not to use the Service to:</p>
          <ul className="list-disc pl-6 mb-6 text-emerald-700">
          ...
          <h2 className="text-2xl font-semibold text-emerald-900 mt-8 mb-4">4. Intellectual Property Rights</h2>
          <p className="text-emerald-700 mb-6">
          ...
          <h2 className="text-2xl font-semibold text-emerald-900 mt-8 mb-4">5. User-Generated Content</h2>
          ...
          <h2 className="text-2xl font-semibold text-emerald-900 mt-8 mb-4">6. Privacy Policy</h2>
          <p className="text-emerald-700 mb-6">
            Your privacy is important to us. Please review our Privacy Policy, which also governs your use of the Service, to understand our practices.
          </p>

          <h2 className="text-2xl font-semibold text-emerald-900 mt-8 mb-4">7. Disclaimers</h2>
          <p className="text-emerald-700 mb-6">
          ...
          <h2 className="text-2xl font-semibold text-emerald-900 mt-8 mb-4">8. Limitation of Liability</h2>
          <p className="text-emerald-700 mb-6">
          ...
          <h2 className="text-2xl font-semibold text-emerald-900 mt-8 mb-4">9. Termination</h2>
          <p className="text-emerald-700 mb-6">
          ...
          <h2 className="text-2xl font-semibold text-emerald-900 mt-8 mb-4">10. Governing Law</h2>
          <p className="text-emerald-700 mb-6">
          ...
          <h2 className="text-2xl font-semibold text-emerald-900 mt-8 mb-4">11. Changes to Terms</h2>
          <p className="text-emerald-700 mb-6">
            We reserve the right, at our sole discretion, to modify or replace these Terms at any time. If a revision is material, we will try to provide at least 30 days notice prior to any new terms taking effect. What constitutes a material change will be determined at our sole discretion.
          </p>

          <h2 className="text-2xl font-semibold text-emerald-900 mt-8 mb-4">12. Contact Information</h2>
          <div className="bg-emerald-50/80 p-6 rounded-xl ring-1 ring-white/40 border border-emerald-200/60">
            <p className="text-emerald-700 mb-4">If you have any questions about these Terms of Service, please contact us:</p>
