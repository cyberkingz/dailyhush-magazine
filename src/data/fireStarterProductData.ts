...
export const fireStarterProductData = {
  ...
  comparison: {
    ...
    rows: [
      ...
      { feature: 'Cost', values: ['$67', '$750-900', '$70-120/yr', '$0-30'] },
    ],
  },
  ...
  reviews: {
    ...
    featured: [
      ...
      // 5 STARS - Work context with failure moment
      {
        ...
        rating: 5,
        date: 'November 2024',
        review: "After difficult patient conversations (I'm a nurse), I physically tense up and replay how I LOOKED—whether I sounded competent, whether they saw I was faking it, what they thought of me. First time I tried this after a bad shift, I was too activated to even read the cards—just stared at them like they were in another language. Second attempt a week later: actually followed the steps and it worked. Now it's automatic. The body-based stuff matters way more than I expected. Keep the cards in my scrubs pocket.",
        overthinkerType: 'Chronic Overthinker',
        verified: true,
      },
      ...
      // 5 STARS - Specific metric
      {
        ...
        rating: 5,
        date: 'September 2025',
        review: "Used to replay work emails obsessing over how I sounded, whether people thought I was stupid, whether I exposed myself as incompetent—tracked it at an average of 45 minutes per email (yes, I'm that person). With this, I've gotten it down to under 10 minutes most times. The Interrupt step is genius because it forces you to DO something instead of just thinking about the thinking. Sometimes I still forget to use it, but when I do, it works. The cards live on my desk next to my monitor.",
        overthinkerType: 'Overthinkaholic',
        verified: true,
      },
    ],
