  ...
  return (
    <div className="container-prose py-16">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">Legal Notices / Mentions Légales</h1>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">1. Website Publisher / Éditeur du Site</h2>
          <div className="bg-gray-50 p-6 rounded-lg mb-6">
            <div className="text-gray-700 space-y-2">
              ...
              <p><strong>Email:</strong> <a href="mailto:hello@daily-hush.com" className="text-yellow-600 hover:text-yellow-700">hello@daily-hush.com</a></p>
              <p><strong>Phone / Téléphone:</strong> <a href="tel:+12013670512" className="text-yellow-600 hover:text-yellow-700">+1 (201) 367-0512</a></p>
            </div>
          </div>

          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">2. Publication Director / Directeur de la Publication</h2>
          <p className="text-gray-700 mb-6">
            The director of publication is the legal representative of Red Impact LLC DBA DailyHush.
          </p>

          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">3. Website Hosting / Hébergement du Site</h2>
          <div className="bg-gray-50 p-6 rounded-lg mb-6">
            <div className="text-gray-700 space-y-2">
              ...
              <p><strong>Website:</strong> <a href="https://www.netlify.com" target="_blank" rel="noopener noreferrer" className="text-yellow-600 hover:text-yellow-700">www.netlify.com</a></p>
            </div>
          </div>

          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">4. Intellectual Property / Propriété Intellectuelle</h2>
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">5. Personal Data Protection / Protection des Données Personnelles</h2>
          <p className="text-gray-700 mb-4">
          ...
          <p className="text-gray-700 mb-6">
            ...
            please refer to our <a href="/privacy" className="text-yellow-600 hover:text-yellow-700">Privacy Policy</a>.
          </p>
          <div className="bg-gray-50 p-6 rounded-lg mb-6">
            <p className="text-gray-700 mb-2"><strong>Data Protection Contact / Contact Protection des Données:</strong></p>
            <p className="text-gray-700">Email: <a href="mailto:hello@daily-hush.com" className="text-yellow-600 hover:text-yellow-700">hello@daily-hush.com</a></p>
          </div>

          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">6. Cookies and Tracking Technologies / Cookies et Technologies de Suivi</h2>
          <p className="text-gray-700 mb-6">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">7. Limitation of Liability / Limitation de Responsabilité</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">8. Applicable Law and Jurisdiction / Loi Applicable et Juridiction</h2>
          <p className="text-gray-700 mb-6">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">9. Reporting Content / Signalement de Contenu</h2>
          <p className="text-gray-700 mb-6">
            If you believe any content on this website violates your rights or applicable laws,
            please contact us immediately at <a href="mailto:hello@daily-hush.com" className="text-yellow-600 hover:text-yellow-700">hello@daily-hush.com</a> with
            a detailed description of the alleged violation.
          </p>

          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">10. Updates to Legal Notices / Modifications des Mentions Légales</h2>
          <p className="text-gray-700 mb-6">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">11. Contact Us / Nous Contacter</h2>
