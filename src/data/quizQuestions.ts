...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    type: 'single',
    question:
      'How often do your thoughts spiral from a small worry into worst-case scenarios?',
    options: [
  ...
  },
  {
    ...
    type: 'single',
    question:
      'After social interactions, do you analyze what you said or how you came across?',
    options: [
  ...
  // SECTION 3: Decision Fatigue & Control
  {
    ...
    type: 'single',
    question:
      'How long do you compare options for everyday choices (outfit, restaurant, plan)?',
    options: [
  ...
  },
  {
    ...
    type: 'single',
    question:
      'How often do you need reassurance from others before deciding something small?',
    options: [
  ...
  },
  {
    ...
    type: 'single',
    question:
      'How often do you compare your looks, life, or progress to others online?',
    options: [
