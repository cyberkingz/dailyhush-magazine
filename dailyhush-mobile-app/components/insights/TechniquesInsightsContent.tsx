    ...
    return (
      <View
        ...
        <Text
          ...
          After you complete a few spiral interrupts, we'll show you which techniques work best for
    ...
    <>
      ...
      {rankings[0] && (
        <View
          ...
          <Text
            ...
            {rankings[0].avgReduction.toFixed(1)} point average reduction •{' '}
            {rankings[0].successRate}% success rate
          </Text>
      ...
      <View
        ...
        <Text
          ...
          We track which techniques reduce your spiral intensity most effectively. Over time, we
          prioritize techniques that work best for your unique patterns.
        </Text>
        ...
        <Text
          ...
          A 2+ point reduction (8 → 6 or better) is considered successful. Your data stays private
          and is only used to personalize your experience.
        </Text>
      </View>
    </>
  );
