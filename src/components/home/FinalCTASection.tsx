...
export default function FinalCTASection() {
  return (
    <section
      className="relative py-16 md:py-20 lg:py-24 bg-gradient-to-br from-emerald-50/80 via-white to-amber-50/40 overflow-hidden"
      aria-labelledby="final-cta-heading"
    >
      {/* Background decoration */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-20 left-10 w-96 h-96 bg-emerald-500/8 rounded-full blur-3xl" />
      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <div className="hidden lg:block mt-8 space-y-4">
              {objectionCrushers.map((item, index) => (
                <details
                  key={index}
                  className="bg-white/60 backdrop-blur-xl rounded-lg p-4 border border-emerald-200/40 hover:border-emerald-400/60 transition-colors group"
                >
                  ...
                  <p className="mt-2 text-emerald-700 pl-4 border-l-2 border-emerald-400">
                    {item.response}
                  </p>
                </details>
              ))}
          ...
          <div className="lg:sticky lg:top-24">
            <div className="bg-white shadow-2xl rounded-3xl p-8 md:p-10 border border-emerald-200 relative">
              {/* Guarantee badge */}
              <div className="absolute -top-6 left-1/2 transform -translate-x-1/2">
                <div className="bg-emerald-600 text-white px-6 py-2 rounded-full font-bold text-sm shadow-lg flex items-center gap-2 animate-pulse">
              ...
              <div className="mt-4">
                ...
                {/* What they get */}
                <div className="bg-emerald-50/50 rounded-xl p-4 mb-6 border border-emerald-200/50">
                ...
                <Link
                  to="/quiz"
                  className="w-full inline-flex items-center justify-center gap-2 bg-amber-500 hover:bg-amber-600 text-white font-bold px-8 py-5 rounded-full transition-all shadow-[0_4px_20px_rgba(245,158,11,0.4)] hover:shadow-[0_6px_28px_rgba(245,158,11,0.5)] hover:scale-[1.02] active:scale-95 text-lg group"
                >
                  Start Free Quiz
                ...
                <div className="mt-6 pt-6 border-t border-emerald-200">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-emerald-800">
                      <p className="font-semibold mb-1">90-Day Shame-Interruption Guarantee</p>
        ...
        <div className="lg:hidden mt-12 space-y-4">
          ...
          {objectionCrushers.map((item, index) => (
            <details
              key={index}
              className="bg-white/60 backdrop-blur-xl rounded-lg p-4 border border-emerald-200/40"
            >
        ...
        <div className="mt-16 max-w-3xl mx-auto text-center">
          <div className="bg-gradient-to-br from-emerald-50 to-amber-50/30 rounded-2xl p-8 border border-emerald-200">
